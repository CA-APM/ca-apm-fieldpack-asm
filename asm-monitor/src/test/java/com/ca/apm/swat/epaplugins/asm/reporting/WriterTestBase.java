...
public abstract class WriterTestBase {
    ...
    public void restTest1() {
        if ((null == writer) || (null == metricPrefix)) {
            Assert.fail("initialize variables writer and metricPrefix before test!");
        }
        ...
        writer.writeStringMetric(metricPrefix + "|Sample Data1|Strings:StringEvent",
    ...
    public void restTest2() {
        ...
        writer.writeStringMetric(metricPrefix + "|Sample Data2|Strings:StringEvent",
            "The quick brown fox jumps over the lazy dog");
        writer.writeIntRate(metricPrefix + "|Sample Data2|Ints:IntRate", 30);

        writer.writePerIntervalCounter(metricPrefix + "|Sample Data2|Ints:PerIntervalCounter",
            1234);

        writer.writeTimestamp(metricPrefix + "|Sample Data2|Timestamp:Timestamp", new Date());

        writer.writeIntCounterForceExist(metricPrefix + "|Sample Data2|Ints:IntCounterForceExists",
            1234);
