    ...
    public void printAsmNode() {
        ...
        try {
            ...
            String[] notExpectedMetrics = {
                                           ...
                                           METRIC_TREE + METRIC_PATH_SEPARATOR + "Monitors|Tests|Simple JMeter recording" + (stations ? VANCOUVER : "") + "|002 /usermanual/index.html:Error Count",
    ...
    public void stepFormatDigits() {
        ...
        try {
            ...
            String[] expectedMetrics = {
                                        ...
                                        "Monitors|Tests|Simple JMeter recording" + (stations ? VANCOUVER : "") + "|02 /usermanual/index.html:Error Count",
    ...
    public void stepFormatPrefix() {
        ...
        try {
            ...
            String[] expectedMetrics = {
                                        ...
                                        "Monitors|Tests|Simple JMeter recording" + (stations ? VANCOUVER : "") + "|Test 002 /usermanual/index.html:Error Count",
    ...
    public void stepFormatUrl() {
        ...
        try {
            ...
            String[] expectedMetrics = {
                                        ...
                                        "Monitors|Tests|Simple JMeter recording" + (stations ? VANCOUVER : "") + "|002:Error Count",
