...
EpaCmd="java -Xdebug -Xms${MIN_HEAP_VAL_IN_MB}m -Xmx${MAX_HEAP_VAL_IN_MB}m -Dcom.wily.introscope.epagent.properties=./AppSyntheticMonitor.properties -cp lib/EPAgent.jar:lib/ca.apm.swat.asm-monitor.jar com.wily.introscope.api.IntroscopeEPAgent"
#echo $EpaCmd
