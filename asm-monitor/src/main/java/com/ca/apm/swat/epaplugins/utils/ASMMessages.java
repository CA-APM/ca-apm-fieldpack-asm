...
public class ASMMessages {
	...
	public static final String connectionRetry1					= "connectionRetry";
	public static final String connectionRetry2					= "connectionRetry";
	public static final String connectionRetry3					= "connectionRetry";
	public static final String connectionRetry4					= "connectionRetry";
